...
pandas é a biblioteca para manipular dados tabulares (planilhas). Os dois objetos principais:

- **Series** — uma coluna (como uma lista com índice)
- **DataFrame** — tabela inteira (várias colunas)
...
### Exercício 1
Crie um DataFrame com PIB, inflação e desemprego de 5 países de sua escolha. Calcule a correlação entre PIB e inflação.

### Exercício 2
Baixe o IPCA (código 433) e a SELIC (código 11) de 2010 até hoje. Crie uma coluna com a taxa de juros real (SELIC - IPCA).

### Exercício 3
Use a base do Banco Mundial (WDI) para baixar PIB per capita de 10 países. Filtre apenas países com PIB per capita acima da média.

### Exercício 4
Baixe o IPCA acumulado em 12 meses (código 13522). Calcule média móvel de 3 meses e salve em CSV.

<details>
<summary>Solução Exercício 2</summary>
...
Quando dominar pandas, me chame para a **Apostila 3 — matplotlib e seaborn**. Você vai aprender a transformar esses dados em gráficos prontos para publicação.
