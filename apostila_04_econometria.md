...
Você vai usar `statsmodels` para fazer a parte econométrica. É a biblioteca mais completa.
...
| `R-squared` (0.996) | 99,6% da variação do consumo é explicada pela renda |
...
### Exercício 1
Baixe dados de IPCA e SELIC de 2010 a 2026. Faça uma regressão de IPCA contra SELIC defasada em 1 mês. Interprete.

### Exercício 2
Teste a Curva de Phillips para o Brasil: regrida IPCA contra desemprego e IPCA defasado.

### Exercício 3
Encontre o melhor modelo ARIMA para o IPCA e faça previsão para 12 meses.

### Exercício 4
Teste se SELIC causa IPCA no sentido de Granger. Em quais defasagens?

### Exercício 5
Monte um painel com 5 países (dados anuais, 2010-2025) e teste a relação entre PIB e inflação.
...
| Painel (fe) | `PanelOLS.from_formula("y ~ x + EntityEffects", data=df)` |
